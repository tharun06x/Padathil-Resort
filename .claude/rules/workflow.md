...
2. **Screenshot** the rendered page using Puppeteer (`nx puppeteer screenshot index.html --fullpage` or equivalent). If the page has distinct sections, capture those individually too.
